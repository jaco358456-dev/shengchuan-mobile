...
<div class="wrapper">
    ...
    <div class="rev_slider_wrapper fullwidthbanner-container" style="margin: 0 auto; background-color: #f7f8fa; padding: 0; color: #fff; margin-top: 0; margin-bottom: 0;">
        <div id="rev-slider4" class="rev_slider fullwidthabanner" style="display: none;">
            <ul>
                              <!-- Slide -->
                ...
                <li data-transition="zoomin" data-slotamount="7" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000" data-rotate="0" data-saveperformance="off" data-title="Creative People">
                    <!-- Main Image -->
                    <img src="admin/uploads/itemslider/slider_no0139.jpg" alt="" data-bgposition="center center" data-kenburns="on" data-duration="10000" data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="120" data-rotatestart="0" data-rotateend="0" data-offsetstart="0 -500" data-offsetend="0 500" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                    <!-- Layers -->
                    <div class="tp-caption tp-resizeme rs-parallaxlevel-0 color-white"
                        data-x="['center','center','center','center']" data-hoffset="['0,'0','0','0']"
                        data-y="['middle','middle','middle','middle']" data-voffset="['-140','-140','-140','-90']"
                ...
                <li data-transition="zoomin" data-slotamount="7" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000" data-rotate="0" data-saveperformance="off" data-title="Creative People">
                    <!-- Main Image -->
                    <img src="admin/uploads/itemslider/slider_no0140.jpg" alt="" data-bgposition="center center" data-kenburns="on" data-duration="10000" data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="120" data-rotatestart="0" data-rotateend="0" data-offsetstart="0 -500" data-offsetend="0 500" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                    <!-- Layers -->
                    <div class="tp-caption tp-resizeme rs-parallaxlevel-0 color-white"
                        data-x="['center','center','center','center']" data-hoffset="['0,'0','0','0']"
                        data-y="['middle','middle','middle','middle']" data-voffset="['-140','-140','-140','-90']"
                ...
                <li data-transition="zoomin" data-slotamount="7" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000" data-rotate="0" data-saveperformance="off" data-title="Creative People">
                    <!-- Main Image -->
                    <img src="admin/uploads/itemslider/slider_no0181.jpg" alt="" data-bgposition="center center" data-kenburns="on" data-duration="10000" data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="120" data-rotatestart="0" data-rotateend="0" data-offsetstart="0 -500" data-offsetend="0 500" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                    <!-- Layers -->
                    <div class="tp-caption tp-resizeme rs-parallaxlevel-0 color-white"
                        data-x="['center','center','center','center']" data-hoffset="['0,'0','0','0']"
                        data-y="['middle','middle','middle','middle']" data-voffset="['-140','-140','-140','-90']"
                ...
                <li data-transition="zoomin" data-slotamount="7" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000" data-rotate="0" data-saveperformance="off" data-title="Creative People">
                    <!-- Main Image -->
                    <img src="admin/uploads/itemslider/slider_no0182.jpg" alt="" data-bgposition="center center" data-kenburns="on" data-duration="10000" data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="120" data-rotatestart="0" data-rotateend="0" data-offsetstart="0 -500" data-offsetend="0 500" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                    <!-- Layers -->
                    <div class="tp-caption tp-resizeme rs-parallaxlevel-0 color-white"
                        data-x="['center','center','center','center']" data-hoffset="['0,'0','0','0']"
                        data-y="['middle','middle','middle','middle']" data-voffset="['-140','-140','-140','-90']"
    ...
    <div class="bg-color-sky-light">
        <div class="content-sm container">
            ...
            <div class="heading-v1 text-center margin-b-80">
                <h2 class="heading-v1-title">京華系列</h2>
				<p class="heading-v1-text">60x60cm</p>
                <p>產品顏色、紋路及尺寸，請以實品為準。
<br> 
<br> 
<a href="https://www.redanttile.com.tw/sales.php" target="_blank" style="font-size: 15px; font-family: Noto Sans TC’, sans-serif">【 銷售據點 】</a></p>
            </div>
            <!-- End Heading v1 -->
                          ...
                          <div class="row margin-b-20">
                            ...
                            <div class="col-sm-6 sm-margin-b-70">
                    <!-- Team v1 -->
                    <div class="team-v1">
                        <img class="full-width img-responsive" src="admin/uploads/product/product0877.jpg">
                        <div class="team-v1-content">
                            <h4>HD66RAQ2505</h4>
                                <p>600x600mm．霧面</p>
                        </div>
                    </div>
                    ...
                    <!-- Team v1 -->
                    <div class="team-v1">
                        <img class="full-width img-responsive" src="admin/uploads/product/product0819.jpg">
                        <div class="team-v1-content">
                            <h4>HD66RAQ2502</h4>
                                <p>600x600mm．霧面</p>
                        </div>
            ...
            </div>              <div class="row margin-b-20">
                
                            <div class="col-sm-6 sm-margin-b-70">
                    <!-- Team v1 -->
                    <div class="team-v1">
                        <img class="full-width img-responsive" src="admin/uploads/product/product0704.jpg">
                        <div class="team-v1-content">
                            <h4>HD66RAQ2501</h4>
                                <p>600x600mm．霧面</p>
                        </div>
                    ...
                    <!-- Team v1 -->
                    <div class="team-v1">
                        <img class="full-width img-responsive" src="admin/uploads/product/product0705.jpg">
                        <div class="team-v1-content">
                            <h4>HD66RAQ2598特特</h4>
                                <p>600x600mm．霧面</p>
                        </div>
    ...
    <div class="content-md container">
                ...
                <article class="news-v10">
                    <div class="center-content-hor-wrap-sm">
                            ...
                            <div class="news-v10-media">
                                <img class="news-v10-media-img" src="admin/uploads/item/icons0038.jpg?1783956951">
                            </div>
                        </div>
                                                                    </div>
                </article>
        ...
        <!-- Heading v1 -->
        <div class="heading-v1 text-center margin-b-80">
            <h2 class="heading-v1-title"></h2>
            <p></p>
        </div>
        <!-- End Heading v1 -->

        <div id="i-banner-v2" class="carousel slide carousel-fade" data-ride="carousel">
            <!-- Wrapper for slides -->
            ...
            <!-- Indicators -->
            <ol class="carousel-indicators theme-ci-v1">
                            </ol>
            <!-- End Indicators -->
        </div>
    </div>
    <!-- End Interactive Banner v2 -->		
		
        <!-- Paginations v3 -->
        <div class="container">
            <div class="paginations-v3 text-center margin-b-60">
            <ul class="pagers-v2">
                                <li><a class="radius-3" href="wood1.php?item_no=0022">Previous</a></li>
                                <li><a class="radius-3" href="wood.php?cate_no=02">BACK TO PRODUCTS </a></li>
                            </ul>
            </div>
        </div>
        <!-- End Paginations v3 -->
...
<script type="text/javascript" src="assets/scripts/portfolio/portfolio-2-col-grid.js"></script>
